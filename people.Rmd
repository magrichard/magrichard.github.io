...
<img src="pictures/nicolas_homberg.jpg " align="middle" height="150" margin="0 auto" />
...
- PhD student in statistics, co-supervised by Yuna Blum (IGDR, Rennes) and David Causeur (IRMAR, Rennes), part of the PhD network of the [M4DI](https://m4di.univ-amu.fr/) project (PEPR Santé Numérique).
- Contact: hugo.barbot[at]univ-grenoble-alpes.fr
- [Website](https://hugobarbot.github.io/index.html)  
...
- Data challenge organisation, platform development, project Codabench @UGA  
- IR in bioinformatics, GRICAD UGA Mesocentre
- Contact: nicolas.homberg[at]univ-grenoble-alpes.fr
...
- Contact: luis.martin-pena[at]univ-grenoble-alpes.fr
