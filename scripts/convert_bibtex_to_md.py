...
def format_citation(citation, max_authors=12):
...
for citation in bib_database.entries:
    ...
    authors_list = ", ".join(get_authors(citation, format="abbrvnat"))
    md = md + "authors: " + '"' + authors_list + '"' + "\n"
    md = md + "journal: " + '"' + citation.get("journal", "") + '"' + "\n"
